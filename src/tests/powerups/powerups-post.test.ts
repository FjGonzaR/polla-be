...
describe('POST /powerups/predictions', () => {
  it('success → 201 + record in DB', async () => {
    ...
    expect(res.json()).toEqual({
      darkHorse: { teamId: darkHorse.id, name: darkHorse.name, code: darkHorse.code, isTop8: false, flag: darkHorse.flag, pct: null },
      disappointment: { teamId: disappointment.id, name: disappointment.name, code: disappointment.code, isTop8: true, flag: disappointment.flag, pct: null },
    })
